              ...
              <li className='row-span-5'>
                <NavigationMenuLink asChild>
                  <Link href={category.href}>
                    <div className='flex h-full w-full select-none flex-col justify-end bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md relative overflow-hidden'>
                      <Image
